defmodule SentinelCp.Services.KdlGeneratorTrustStoreTest do
  use SentinelCp.DataCase

  alias SentinelCp.Services.{KdlGenerator, ProjectConfig, Service, UpstreamGroup, TrustStore}
  ...
  describe "trust store KDL generation" do
    test "generates trust_stores block for used trust stores" do
      ...
      assert kdl =~ ~s(ca_file "/etc/sentinel/trust-stores/internal-ca.pem")
    end
