defmodule SentinelCp.ObservabilityTest do
  use SentinelCp.DataCase, async: false

  alias SentinelCp.Observability
  alias SentinelCp.Observability.{Slo, SliComputer, AlertRule, AlertState, AlertEvaluator, Tracer}
  alias SentinelCp.Analytics.{ServiceMetric, MetricRollup, RollupWorker}
