defmodule ZentinelCp.Rollouts.CanaryIntegrationTest do
  use ZentinelCp.DataCase

  alias ZentinelCp.Rollouts
  alias ZentinelCp.Rollouts.{Rollout, CanaryAnalysis}
  ...
  describe "canary tick loop integration" do
    test "extend decision keeps rollout in same state" do
      ...
      for node_id <- first_step.node_ids do
        ZentinelCp.Nodes.Node
        |> ZentinelCp.Repo.get!(node_id)
