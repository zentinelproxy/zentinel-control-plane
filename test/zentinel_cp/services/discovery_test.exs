defmodule ZentinelCp.Services.DiscoveryTest do
  ...
  alias ZentinelCp.Services.{DiscoverySource, DiscoverySync}
  ...
  describe "sync_discovery_source/1" do
    test "adds targets from SRV records" do
      ...
      ZentinelCp.Services.DnsResolver.Mock
  ...
  describe "sync_discovery_source/1 kubernetes" do
    test "syncs kubernetes source using K8s resolver" do
      ...
      ZentinelCp.Services.K8sResolver.Mock
  ...
  describe "DiscoverySyncWorker" do
    alias ZentinelCp.Services.DiscoverySyncWorker
