defmodule ZentinelCp.Analytics.WafEventTest do
  ...
  defp create_project(_) do
    {:ok, org} = ZentinelCp.Orgs.create_org(%{name: "WAF Org", slug: "waf-org"})

    {:ok, project} =
      ZentinelCp.Projects.create_project(%{name: "WAF Project", slug: "waf-proj", org_id: org.id})
