defmodule ZentinelCpWeb.ServicesLive.Index do
  use ZentinelCpWeb, :live_view

  alias ZentinelCp.{Audit, Bundles, Orgs, Projects, Services}
    ...
    case Projects.get_project_by_slug(slug) do
      ...
      project ->
        if connected?(socket) do
          Phoenix.PubSub.subscribe(ZentinelCp.PubSub, "services:#{project.id}")
        end
