defmodule ZentinelCpWeb.RolloutsLive.Index do
  use ZentinelCpWeb, :live_view

  alias ZentinelCp.{Rollouts, Bundles, Orgs, Projects}
  alias ZentinelCp.Rollouts.RolloutTemplate
    ...
    case Projects.get_project_by_slug(slug) do
      ...
      project ->
        if connected?(socket) do
          Phoenix.PubSub.subscribe(ZentinelCp.PubSub, "rollouts:#{project.id}")
        end
