defmodule ZentinelCpWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ZentinelCpWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ZentinelCpWeb.Gettext, "errors", msg, opts)
    end
  end
