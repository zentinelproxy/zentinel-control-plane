defmodule ZentinelCp.Plugins.Plugin do
  @moduledoc """
  Plugin schema for user-uploadable proxy plugins (Wasm/Lua).

  Plugins are project-scoped binaries that run in the Zentinel proxy's
  ...
  schema "plugins" do
    ...
    has_many :plugin_versions, ZentinelCp.Plugins.PluginVersion
