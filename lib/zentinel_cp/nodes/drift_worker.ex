defmodule ZentinelCp.Nodes.DriftWorker do
  @moduledoc """
  ...
  import Ecto.Query
  alias ZentinelCp.{Bundles, Nodes, Projects, Repo}
  alias ZentinelCp.Events, as: Notifications
  alias ZentinelCp.Bundles.Diff
  ...
  defp get_check_interval do
    Application.get_env(:zentinel_cp, :drift_check_interval, @default_check_interval_seconds)
  end
