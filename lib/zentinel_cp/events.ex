defmodule ZentinelCp.Events do
  @moduledoc """
  ...
  ## Usage
      ...
      ZentinelCp.Events.emit("rollout.started", %{rollout_id: id}, project_id: project.id)
  ...
  alias ZentinelCp.Events.{Event, Channel, NotificationRule, DeliveryAttempt, DeliveryWorker}
  ...
  def emit(type, payload \\ %{}, opts \\ []) do
    ...
    case create_event(attrs) do
      {:ok, event} ->
        Phoenix.PubSub.broadcast(ZentinelCp.PubSub, @events_topic, {:event_emitted, event})
    ...
    {:ok, event} =
      create_event(%{
        ...
        payload: %{
          ...
          message: "Test notification from Zentinel CP"
        },
  ...
  def subscribe do
    Phoenix.PubSub.subscribe(ZentinelCp.PubSub, @events_topic)
  end
