defmodule ZentinelCp.Rollouts.Rollout do
  @moduledoc """
  ...
  schema "rollouts" do
    ...
    has_many :steps, ZentinelCp.Rollouts.RolloutStep
    has_many :node_bundle_statuses, ZentinelCp.Rollouts.NodeBundleStatus
    has_many :approvals, ZentinelCp.Rollouts.RolloutApproval
