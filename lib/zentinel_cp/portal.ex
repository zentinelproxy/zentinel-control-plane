defmodule ZentinelCp.Portal do
  @moduledoc """
  ...
  alias ZentinelCp.{Repo, Accounts}
  alias ZentinelCp.Services.OpenApiSpec
  ...
  def list_portal_keys(project_id, user_id) do
    from(k in ZentinelCp.Accounts.ApiKey,
  ...
  def revoke_portal_key(key_id, user_id) do
    case Repo.get(ZentinelCp.Accounts.ApiKey, key_id) do
      nil ->
        {:error, :not_found}
