defmodule SentinelCp.Services.Acme.Renewal do
  @moduledoc """
  ...
  alias SentinelCp.Services.Acme.{Crypto, ChallengeStore}
  alias SentinelCp.Services.{Certificate, CertificateCrypto}
  ...
  defp acme_client do
    Application.get_env(:sentinel_cp, :acme_client, SentinelCp.Services.Acme.Client.HTTP)
  end

  defp default_directory_url do
    Application.get_env(:sentinel_cp, :acme, [])
