defmodule SentinelCp.Services.Acme.Crypto do
  @moduledoc """
  ...
  @rsa_sha256_algo_der <<0x30, 0x0D, 0x06, 0x09, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x0B, 0x05, 0x00>>
  ...
  @rsa_spki_algo_der <<0x30, 0x0D, 0x06, 0x09, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x01, 0x05, 0x00>>
  # EC public key AlgorithmIdentifier: OID 1.2.840.10045.2.1 + P-256 OID
  @ec_spki_algo_der <<0x30, 0x13, 0x06, 0x07, 0x2A, 0x86, 0x48, 0xCE, 0x3D, 0x02, 0x01, 0x06, 0x08, 0x2A, 0x86, 0x48, 0xCE, 0x3D, 0x03, 0x01, 0x07>>

  defp csr_signature_info(k) when elem(k, 0) == :ECPrivateKey, do: {@ec_sha256_algo_der, :sha256}
  defp csr_signature_info(k) when elem(k, 0) == :RSAPrivateKey, do: {@rsa_sha256_algo_der, :sha256}
